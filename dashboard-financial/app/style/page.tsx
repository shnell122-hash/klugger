      ...
      <div className="kstyle-wrap">
        ...
        <Sec title="Badges">
          <div className="kstyle-row">
            ...
            <Badge variant="up">▲ 4.2% plusvalía</Badge>
        ...
        <Sec title="Arte en movimiento (GSAP + ScrollTrigger)">
          ...
          <ScrollReveal>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 14 }}>
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div key={i} className="kcard" data-reveal style={{ padding: 16, height: 120, display: "flex", alignItems: "flex-end" }}>
                  <strong>Zona {i}</strong>
                </div>
              ))}
            </div>
          </ScrollReveal>
